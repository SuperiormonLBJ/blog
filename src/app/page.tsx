        ...
        <div className="apple-container text-center relative z-10">
          ...
          <div className="relative flex flex-col items-center justify-center min-h-[60vh]">
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-20">
                ...
                <div className="text-left max-w-2xl">
                  ...
                  <p className="text-[var(--secondary)] mb-4">
                    Wassup guys! I'm a passionate software engineer and AI innovator, focused on creating meaningful digital experiences. 
              ...
              {/* Back Button with Game Style */}
              <button 
                onClick={() => setShowAbout(false)}
                className="absolute bottom-0 group relative px-8 py-4 bg-[#2a2a2a] text-[#00ff00] font-mono border-2 border-[#00ff00] 
              ...
              >
                ...
                <div className="absolute -top-1 -left-1 w-2 h-2 bg-[#00ff00]"></div>
                <div className="absolute -top-1 -right-1 w-2 h-2 bg-[#00ff00]"></div>
                <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-[#00ff00]"></div>
                <div className="absolute -bottom-1 -right-1 w-2 h-2 bg-[#00ff00]"></div>
              </button>
            </div>
          </div>
        </div>
